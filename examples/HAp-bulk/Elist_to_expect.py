...
if __name__ == "__main__":
    ...
    # Polarization
    tot_pol2_rep = np.array([np.abs(rep.count((1,0))-rep.count((1,1))) for rep in reps])/4
    #print(tot_pol2_rep)
    ...
    for i in range(len(kTs)):
        ...
        print(kTs[i]/kb, tot_pol_expect[i], num_V_O_expect[i], num_O_HO_expect[i], num_O_OH_expect[i],
